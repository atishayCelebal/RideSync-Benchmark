...
-- Create spatial index for location_updates using regular PostgreSQL
-- Note: This creates a basic spatial index without PostGIS dependency
CREATE INDEX idx_location_updates_lat_lng ON location_updates (latitude, longitude);
